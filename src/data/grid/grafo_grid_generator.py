...
def __gerar_instancia_grid():
    ...
    grafo.adicionar_aresta("1", "4", atributos[2])
    grafo.adicionar_aresta("2", "1", atributos[1])
    grafo.adicionar_aresta("2", "3", atributos[1])
    grafo.adicionar_aresta("2", "5", atributos[1])
    grafo.adicionar_aresta("3", "2", atributos[2])
    grafo.adicionar_aresta("3", "6", atributos[1])
    grafo.adicionar_aresta("4", "7", atributos[2])
    grafo.adicionar_aresta("4", "1", atributos[1])
    grafo.adicionar_aresta("4", "5", atributos[1])
    grafo.adicionar_aresta("5", "4", atributos[1])
    grafo.adicionar_aresta("5", "6", atributos[1])
    grafo.adicionar_aresta("5", "8", atributos[2])
    grafo.adicionar_aresta("5", "2", atributos[1])
    grafo.adicionar_aresta("6", "3", atributos[1])
    grafo.adicionar_aresta("6", "9", atributos[1])
    grafo.adicionar_aresta("6", "5", atributos[2])
    grafo.adicionar_aresta("7", "8", atributos[2])
    grafo.adicionar_aresta("7", "4", atributos[2])
    grafo.adicionar_aresta("8", "9", atributos[2])
    grafo.adicionar_aresta("8", "7", atributos[2])
    grafo.adicionar_aresta("8", "5", atributos[2])
    grafo.adicionar_aresta("9", "6", atributos[1])
    grafo.adicionar_aresta("9", "8", atributos[1])
